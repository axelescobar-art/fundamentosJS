console.log("conexion exitosa conJS....")
...
function compraDescuento(){
    let precio = 2500;
    alert(`El precio es de: $${precio} \nEl descuento: $${precio} - {precio * 0,2}`)
}
...
function calcularTemperatura(){
    ...
    alert(`La temperatura actual es: ${temperatura} \nLa temperatura aumentada es: ${aumentada} \nLa temperatura disminuida es: $(disminuido) \nEl resultado de la temporada es: $(resultado)`)
}
...
function calcularPotencia(){
    let num1 = 3;
    let num2 = 4;
    let potencia = num1 ** num1;
    let multi = potencia * 2;
    alert(`El resultado de 3 elevado a 4 es: ${potencia * 2} \nEl resultado final menos 10 es: ${multi - 10}`)
}
